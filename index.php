...
<body>
  ...
  <div class="row">
    ...
    $sql = "SELECT m.id_mobil, m.nama_mobil, m.tahun, m.warna, nama_kategori
            FROM mobil m 
    ...
    if ($result->num_rows > 0) {
        while($row = $result->fetch_assoc()) {
            ...
            echo '<h4><b>' . $row["id_mobil"] . '</b></h4>';
            echo '<p>nama_mobil: ' . $row["nama_mobil"] . '</p>';
            echo '<p>tahun: ' . $row["tahun"] . '</p>';
            echo '<p>warna: ' . $row["warna"] . '</p>';
            echo '<p>nama_kategori: ' . $row["nama_kategori"] . '</p>';
